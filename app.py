...
from localization import TEXTS, get_text, format_text # Assicurati che localization.py sia aggiornato per v1.2
from config import (
...
# ================================================================
# Modificato: layout="centered", initial_sidebar_state="collapsed"
st.set_page_config(page_title=T("PAGE_TITLE"), layout="centered", initial_sidebar_state="collapsed") # PAGE_TITLE farà riferimento a v1.2 da localization

# ================================================================
# Toggle Button Lingua / Language Toggle Button
# ================================================================
# Posizionato in alto a destra della pagina principale
...
# ================================================================
st.title(T("MAIN_TITLE")) # MAIN_TITLE farà riferimento a v1.2 da localization
...
# ================================================================
# Sidebar per Istruzioni / Sidebar for Instructions (Contenuto spostato qui)
# ================================================================
with st.sidebar:
    st.header(T("INSTRUCTIONS_HEADER"))
    # Mostra il testo delle istruzioni
    st.markdown(T("INTRO_TEXT_NEW"), unsafe_allow_html=True)

    # Immagini di esempio nella sidebar
    img_col_side1, img_col_side2, img_col_side3 = st.columns([0.05, 0.9, 0.05])
    with img_col_side2: 
        try:
...
if not st.session_state.action_performed and not uploaded_file: 
    output_placeholder.info(F("INITIAL_INFO_NEW").replace("nella sidebar", "nei campi appositi"))

st.markdown("---")
st.markdown(T("FOOTER_TEXT")) # FOOTER_TEXT farà riferimento a v1.2 da localization
